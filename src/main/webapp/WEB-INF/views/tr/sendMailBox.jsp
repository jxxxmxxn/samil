...
<body>
	<main>
		...
		<div class="btn-group" role="group" aria-label="Basic example">
			...
			<a class="btn btn-outline-primary" href="importantMail?empno=${emp.empno}">중요메일함</a> 
			<a class="btn btn-outline-primary active"	href="sendMail?empno=${emp.empno}">보낸메일함</a> 
				...
				<tbody>
					...
					<c:forEach var="mail" items="${mailList}">
						...
						<td onclick="location.href='/tr/mailDetail?mailNo=${mail.mailNo}'"><c:forEach
							...
							<td onclick="location.href='/tr/mailDetail?mailNo=${mail.mailNo}'">${mail.sendDate}</td>
